...
reader.readargs = {
    colors: [
        ...
        _alt1_base__WEBPACK_IMPORTED_MODULE_0__.mixColor(0, 255, 0), //Green Fortune Text
    ]
};
...
let findChat = setInterval(function () {
    if (reader.pos === null)
        ...
        reader.pos.boxes.map((box, i) => {
            (0,jquery__WEBPACK_IMPORTED_MODULE_2__.$)(".chat").append(`<option value=${i}>Chat ${i}</option>`);
        });
