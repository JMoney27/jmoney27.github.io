...
console.log(chatbox.default)
console.log(ChatBoxReader)
console.log(chatbox.defaultcolors)
console.log(ChatBoxReader.getFontColor)
console.log(ChatBoxReader.getMessageTime)
console.log(ChatBoxReader.length)
console.log(ChatBoxReader.name)
